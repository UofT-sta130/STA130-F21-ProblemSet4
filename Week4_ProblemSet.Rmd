...
Your complete .Rmd file that you create for this problem set AND the resulting .pdf (i.e., the one you 'Knit to PDF' from your .Rmd file) must be uploaded into a Quercus assignment (link: [https://q.utoronto.ca/courses/235890/assignments/705700](https://q.utoronto.ca/courses/235890/assignments/705700)) by 11:59 a.m. ET, on October 7. Late problem sets or problems submitted another way (e.g., by email) are *not* accepted.
